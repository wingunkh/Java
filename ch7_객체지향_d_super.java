...
class Point{
	...
	Point(int x,int y){
		this.x=x;
		this.y=y;
	} //생성자의 첫 줄에서 super()를 호출하지 않았으므로 컴파일 후 첫 줄에 super();가 추가된다.
}
