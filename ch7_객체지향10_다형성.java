...
public class ch7_객체지향10_다형성 {
	public static void main(String[] args) {
		Tv t = new Tv(); //지금까지 우리는 생성된 인스턴스를 다루기 위해서, 인스턴스의 타입과 일치하는 타입의 참조변수만을 사용했다.
		
		CaptionTv c = new CaptionTv(); //그러나 클래스가 서로 상속관계에 있을 경우, 부모클래스 타입의 참조변수로 자식클래스의 인스턴스를 참조할 수 있다.
